...
class Category(models.Model):
    ...
    image = models.ImageField(upload_to=get_file_path, null=False, blank=False)  # Fixed: = not -
    description = models.TextField(max_length=500, null=False, blank=False)  # Changed from 70 to reasonable value
    ...
    meta_description = models.TextField(max_length=500, null=False, blank=False)  # Changed from 100
...
class Order(models.Model):
    ...
    payment_id=models.CharField(max_length=25,null=False)


    orderstatus = {
        ("pending","pending"),
        ("out of shipping","out of shopping"),
        ("completed","completed"),
    }

    status=models.CharField(max_length=25,choices=orderstatus,default="pending")
...
class Profile(models.Model):
    ...
    city=models.CharField(max_length=15,null=False)
    state=models.CharField(max_length=15,null=False)
    contry=models.CharField(max_length=15,null=False)
    pincode=models.CharField(max_length=15,null=False)
    created_at = models.DateTimeField(auto_now_add=True)
